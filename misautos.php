...
<head>
    ...
    <link rel="stylesheet" href="misautos.css"> <!-- Este CSS ya está enlazado correctamente -->

</head>
<body> <!-- Agregado el tag <body> de apertura -->
...
<?php if (isset($_SESSION['perfil']) && $_SESSION['perfil'] == 'cliente'): ?>   
            <a href="servicios.php" class="text-white">Servicios</a> |
              <a href="../misautos/misautos.php" class="text-white">Mis autos</a> | <!-- MODIFICADO: Enlace a misautos.php -->
            ...
            <?php if (!isset($_SESSION['email'])): ?>
                <a class="text-white" href="../login/registro.php">Iniciar sesión</a> <!-- MODIFICADO: Ruta a registro.php -->
            <?php else: ?>
